...
(gtk_accel_path "<Actions>/terminal-widget/shift-pagedown" "<Primary><Shift>d")
...
(gtk_accel_path "<Actions>/terminal-window/fullscreen" "F8")
...
(gtk_accel_path "<Actions>/terminal-window/open-folder" "<Primary><Shift>f")
...
(gtk_accel_path "<Actions>/terminal-widget/shift-pageup" "<Primary><Shift>u")
; (gtk_accel_path "<Actions>/terminal-window/zoom-menu" "")
(gtk_accel_path "<Actions>/terminal-window/close-window" "<Super>c")
