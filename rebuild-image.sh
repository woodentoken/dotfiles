#!/usr/bin/env bash
# rebuild.sh: rebuild the custom Kinoite image and stage it with bootc.
#
# Usage:
#   ./rebuild.sh            build + stage; reboot manually afterwards
#   ./rebuild.sh --reboot   build + stage + reboot automatically
set -euo pipefail
